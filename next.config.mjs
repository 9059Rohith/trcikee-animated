...
const defaultBackendUrl = "https://trickee-backend-397358873357.asia-southeast1.run.app";
const backendUrl =
...
const nextConfig = {
  ...
  experimental: { cpus: 2 },
  env: {
    NEXT_PUBLIC_WS_URL: process.env.NEXT_PUBLIC_WS_URL || backendUrl.replace(/\/$/, '').replace(/\/api\/v1$/, '').replace(/^http/, 'ws'),
  },
