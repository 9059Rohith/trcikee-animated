...
const origin = (process.env.BACKEND_URL || 'https://trickee-backend-397358873357.asia-southeast1.run.app').replace(/\/$/, '').replace(/\/api\/v1$/, '');
const res = await fetch(`${origin}/openapi.json`, { signal: AbortSignal.timeout(30_000) });
